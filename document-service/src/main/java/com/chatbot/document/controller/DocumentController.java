...
import com.chatbot.document.model.DocumentExtractionRequest;
import com.chatbot.document.model.DocumentExtractionResponse;
import com.chatbot.document.model.ErrorResponse;
import com.chatbot.document.service.*;
...
public class DocumentController {
    ...
    public ResponseEntity<?> extractText(
        ...
        log.debug("Received document extraction request: {}", file.getOriginalFilename());
    ...
    public ResponseEntity<?> extractTextFromBase64(
        ...
        log.debug("Received base64 document extraction request: {}", request.getFilename());
     ...
     */
    private DocumentExtractionResponse convertPdfResponse(com.chatbot.document.model.PdfExtractionResponse pdfResponse) {
     ...
     */
    private DocumentExtractionResponse convertHwpResponse(com.chatbot.document.model.HwpExtractionResponse hwpResponse) {
        return DocumentExtractionResponse.builder()
