...
import com.chatbot.document.model.PdfExtractionRequest;
import com.chatbot.document.model.PdfExtractionResponse;
import com.chatbot.document.service.PdfExtractionService;
...
public class PdfController {
    ...
    public ResponseEntity<?> extractText(
        ...
        log.debug("Received PDF extraction request: {}", file.getOriginalFilename());
    ...
    public ResponseEntity<?> extractTextFromBase64(
        ...
        log.debug("Received base64 PDF extraction request: {}", request.getFilename());
